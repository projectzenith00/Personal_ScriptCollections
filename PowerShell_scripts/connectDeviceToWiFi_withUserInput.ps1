Write-Output "Please input the name of the Wi-Fi. For Names with spaces, make sure to add the quotation mark symbols at the beginning and end of the Wi-Fi name."
$wifiName = Read-Host "Wi-Fi Name:"; #Replace with the correct Wi-Fi name
